...
USER_PROMPT_TEMPLATE = (
    ...
    '  "image_prompt": "A detailed English prompt for gpt-image-1. Create a VISUALLY STRIKING '
    'photograph related to {topic}. IMPORTANT COMPOSITION RULES: '
    'DO NOT just show the subject in a centered close-up staring at the camera every time. '
    'Instead, VARY the composition creatively — use one of these approaches: '
    '(1) action shot showing the subject DOING something interesting, '
    '(2) dramatic wide-angle showing scale or environment, '
    '(3) unexpected angle (from below, above, macro detail, cross-section), '
    '(4) the subject interacting with its environment in a surprising way, '
    '(5) a visual that reveals the WOW fact itself (e.g. size comparison, the phenomenon in action). '
    'The image should make someone STOP scrolling — it should look unusual, not like a stock photo. '
    'The subject must occupy the UPPER 60% of the frame. The LOWER 40% must be darker/blurred/simple '
    'for text overlay. Specify: exact subject, creative angle, environment, cinematic lighting. '
    'End with: professional photography, 4:5 portrait ratio, no text, no watermarks, no labels."\n'
    "}}"
)
